...
void IngresoNumero (float &valor1,float &valor2,char &Operadores){
    ...
    cin>>Operadores;
    if (Operadores == '+' or Operadores == '-' or Operadores == '*' or Operadores == '/')
    {
...
int main(int argc, char const *argv[])
{
    ...
    do
    {
        ...
        if (valido)
        {
            ...
            cout<<"no ingreso un operador o un valor valido, vuelva a intentarlo o precione f para finalizar"<<endl;
        }
